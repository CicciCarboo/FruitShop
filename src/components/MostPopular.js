...
const MostPopular = () => {
    ...
    useEffect(async () => {    // 18/4, the compiler is not happy without "await". Try to remove "async", check video 7/4 30 min before the end               
    ...
    return(
        <div>
            <h4 className="fruit-category">Most popular fruits</h4>        
            <ul className="fruits">{
